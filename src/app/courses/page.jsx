...
export default function CoursesPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#FFFfff" }}>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-[#313D6A]/10">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <div className="relative max-w-xl mx-auto lg:mx-0">
                <div
                  className="rounded-md md:rounded-full px-4 py-4 shadow-lg"
                ...
                >
                  ...
                  >
                    <Input
                      ...
                      className="flex-1 rounded-md md:rounded-full border-0 bg-white px-4 sm:px-6 py-2 sm:py-3 text-base sm:text-lg"
                    />
                    <Button
                      type="submit"
                      className="rounded-full px-6 sm:px-8 py-2 sm:py-3 text-base sm:text-lg font-semibold"
            ...
            <div className="lg:w-1/2 flex justify-center">
              <Image
                ...
                className="max-w-sm sm:max-w-md w-full h-auto"
              />
            </div>
          </div>
        </div>
