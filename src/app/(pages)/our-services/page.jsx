      ...
      <section className="pt-12 pb-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-2 items-center">
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-[#313D6A] mb-4">
                Home Tutoring
              </h3>
              ...
              <Link
                href="/home-tutoring"
                className="text-white font-semibold px-6 py-2 rounded-md hover:opacity-95 bg-[#313D6A]"
              >
                Read More
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-2 justify-center">
            <div className="order-2 flex flex-col justify-center">
              <h3 className="text-2xl sm:text-3xl text-center font-bold text-[#F5BB07] mb-4">
                Online Tutoring
              </h3>
              ...
              <Link
                ...
                className="text-white w-fit mx-auto font-semibold px-6 py-2 rounded-md hover:opacity-95 bg-[#F5BB07]"
              >
                Read More
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="flex flex-col md:flex-row items-center gap-4 bg-yellow-50 rounded-lg p-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#313D6A]">
                  Individual Sessions
                </h3>
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 bg-green-50 rounded-lg p-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Structured classroom-style courses
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 relative">
            <div className="flex items-center justify-center gap-4 flex-wrap">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 w-full sm:w-[480px] max-w-md flex flex-col justify-between h-[470px]">
                <div className="text-center mb-4">
                  <h3 className="text-lg sm:text-xl font-bold mb-1 text-[#313D6A]">
                    {groupSessions[groupSessionsIndex].title}
                  </h3>
                  <p className="text-sm text-[#F5BB07]">
                ...
                <div className="flex items-center justify-center mb-4">
                  <img
                    src={
                      groupSessions[groupSessionsIndex].image ||
                      '/placeholder.svg'
                    }
                    alt="Instructor"
                  ...
                  <span className="ml-2 text-sm text-gray-600">
                    Instructor ID:{' '}
                    {groupSessions[groupSessionsIndex].instructor}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-[#313D6A]">
      ...
      <section className="pt-12 pb-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <Link
              href="/courses"
              className="px-6  py-2 border-2 font-semibold rounded-md bg-transparent"
              style={{ borderColor: '#F5BB07', color: '#F5BB07' }}
            >
              View All
            </Link>
          </div>
